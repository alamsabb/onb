  ...
  <body>
    ...
    <div class="header">
        ...
        <div class="img-content">
            <h2></h2>
            <span>GIET University, Gunupur  was established by “Vidya Bharati Educational Trust,” Gunupur, Odisha, India in the year 1997. UGC approved GIET University is one of the leading universities in Odisha, located amongst the lush greenery and foothills of the Eastern Ghats of India with the scenic Bansadhara River flowing through its territory.
...
<div class="event" >
    <div class="row justify-content-left text-left">
        <div class="col-sm-4">
            <img src="./assets/img/tech-fest.jpg" width="300px" height="200px" alt="">
 ...
 <div class="col-sm-4">
    ...
    <div class="event-content">  
        <span style="text-align: center;"><br>
            ...
            <a href="https://csefest.in/"> Must visit our site for further details </a>
...
<div class="col-sm-4">
    <div class="row justify-content-left text-left">
    <img src="./assets/img/aids day.jfif" width="300px" height="200px" alt="">
    <div class="event-content">  
        <span style="text-align: center;"><br>
            <h4>Aids Day 🎗️</h4>
            We are glad to share that the CSE department is conducting a workshop for Graphic Designing for the departmental fest AVYAKT 2.O . 
...
<div class="col-sm-4">
    <div class="row justify-content-center text-center">
    <img src="./assets/img/tree plantation.jpg" width="300px" height="200px" alt="">
    <div class="event-content">  
        <span style="text-align: center;"><br>
...
<div class="col-sm-4">
    <div class="row justify-content-right text-right">
    <img src="./assets/img/rally.jpg" width="300px" height="200px" alt="">
    <div class="event-content"> 
        <span style="text-align: center;"><br>
            <h4>Rally 🚶</h4>
            We are glad to share that the CSE department is conducting a workshop for Graphic Designing for the departmental fest AVYAKT 2.O . 
